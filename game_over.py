...
class GameOver:
    def __init__(self, score, win=False):
        self.target = pygame.Vector2(center.x, dimensions.y/3)
    ...
    def update(self, delta):
        ...
        self.position.y = max(self.target.y, self.position.y - pow(100, self.time / 100))
    ...
    def draw(self, surf):
        ...
        pygame.draw.rect(surf, YELLOW, self.container.get_rect(), border_radius=10)
        pygame.draw.rect(surf, BLACK, self.container.get_rect(), width=5, border_radius=10)
